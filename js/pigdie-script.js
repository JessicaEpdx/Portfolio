...
var playerPic = function(playerName) {
  return("<img class='profile-pics' src='http://www.jessicaengel.com/wp-content/themes/JessTheme/images/" + playerName + ".jpg'>");

}

var getDicePicture = function(number){
  number = number.toString()
  return ("<img class='die-pic' src='http://www.jessicaengel.com/wp-content/themes/JessTheme/images/" + number + ".jpg' />");
}
